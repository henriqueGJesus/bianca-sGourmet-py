...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "https://bianca-s-gourmet-356k.vercel.app"],
    # Permitir a origem do frontend (Vue.js)
...
def handle_redirect():
    post = Post("https://www.instagram.com/p/C-OkdeTJjsZ/?utm_source=ig_web_copy_link")
